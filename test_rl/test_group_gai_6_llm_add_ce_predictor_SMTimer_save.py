...
import numpy as np
from env_gai_6_llm_add_ce_predictor_save import ConstraintSimplificationEnv_test
...
def test_group():
    info_name = 'info_dict_gai_6_normal_1021_pre_SMTimer_save.txt'
            ...
            if list1[1] > 300:
                ...
                if file_path not in info_dict.keys():
                    ...
                    if file_path not in info_dict.keys():
                        ...
                        if save_flag:
                            with open('agent_save_1021.pkl', 'rb') as f:
                                agent = pickle.load(f)
                        else:
                            agent = PearlAgent(
                        ...
                        plt.show()
                        with open('agent_save_1021.pkl', 'wb') as f:
                            pickle.dump(agent, f)
                        save_flag = True
