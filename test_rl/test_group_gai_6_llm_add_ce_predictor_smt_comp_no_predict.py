...
import numpy as np
from env_gai_6_llm_add_ce_predictor_docker_no_predict import ConstraintSimplificationEnv_test
...
def test_group():
    info_name = 'info_dict_gai_6_normal_1106_no_pre_smt_comp_llama_3.1:70b_rl_120s.txt'
