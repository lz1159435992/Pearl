...
from test_rl.predictor.smt_comp_QF_LIA.bert_predictor_mask_llm import EnhancedClassifier
from test_rl.predictor.smt_comp_QF_LIA.bert_predictor_2_mask_llm import EnhancedEightClassModelLargeInput
...
def test_group():
    ...
    info_name = 'info_dict_gai_6_normal_1118_pre_llm_llama3.1:70b_1200s_QF_LIA.txt'
    if not os.path.exists(info_name):
        ...
        print(f'文件已存在。')
    with open('/home/lz/PycharmProjects/Pearl/test_rl/predictor/smt_comp_QF_LIA/QF_LIA_test.json', 'r') as file:
            ...
            if list1[1] > 300 and key in result_dict.keys():
                ...
                if file_path not in info_dict.keys():
                    ...
                    try:
                        ...
                        model_path = '/home/lz/PycharmProjects/Pearl/test_rl/predictor/smt_comp_QF_LIA/QF_LIA_bert_predictor_mask_best_llm.pth'  # 或者 'bert_predictor_mask_final.pth'
                        state_dict = torch.load(model_path)
                        model.load_state_dict(state_dict)
                        model.eval()
                        model_time = EnhancedEightClassModelLargeInput()
                        model_time.load_state_dict(torch.load('/home/lz/PycharmProjects/Pearl/test_rl/predictor/smt_comp_QF_LIA/QF_LIA_bert_predictor_2_mask_best_model_llm.pth'))
                        model_time.eval()
