...
# 创建求解器
    ...
    # 定义常量为位向量
    const_57 = BitVecVal(57, 8)
    const_2 = BitVecVal(2, 8)
    const_1024 = BitVecVal(1024, 8)
    const_511 = BitVecVal(511, 8)
    const_256 = BitVecVal(256, 8)
    const_128 = BitVecVal(128, 8)
    const_97 = BitVecVal(97, 8)
    const_15 = BitVecVal(15, 8)
    const_42 = BitVecVal(42, 8)
    const_123456 = BitVecVal(123456, 8)
    const_789012 = BitVecVal(789012, 8)
    const_345678 = BitVecVal(345678, 8)
    const_1253456 = BitVecVal(1253456, 8)
    const_1000000 = BitVecVal(1000000, 8)
    const_5000 = BitVecVal(5000, 8)
    const_6 = BitVecVal(6, 8)
    const_2_bit = BitVecVal(2, 8)
    const_FF = BitVecVal(0xFF, 8)
    const_3 = BitVecVal(3, 8)
    const_73 = BitVecVal(73, 8)
    const_1F = BitVecVal(0x1F, 8)
    const_3_bit = BitVecVal(3, 8)
    const_71 = BitVecVal(71, 8)
    const_12 = BitVecVal(12, 8)
    const_128 = BitVecVal(128, 8)
    const_7 = BitVecVal(7, 8)
    const_8 = BitVecVal(8, 8)
