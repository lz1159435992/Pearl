...
import numpy as np
from env_gai_4_v2 import ConstraintSimplificationEnv_test
...
def test_group():
    info_name = 'info_dict_gai_4_normal_929_QF_LIA.txt'
    ...
    # 遍历目录
    output_path = 'result_dict_no_increment_QF_LIA_924.txt'
            ...
            if 'starexec_description.txt' in file_path or '52759_b3ecd2335fd16ec2eee2_9_UFDTBV' in file_path or 'sll-optional-1.i_1' in file_path:
                ...
                if file_path not in info_dict.keys():
                    ...
                    if file_path not in result_dict.keys():
                        ...
                        result_dict[file_path] = solve_list
                        with open(output_path, 'w') as file:
                            json.dump(result_dict, file, indent=4)
