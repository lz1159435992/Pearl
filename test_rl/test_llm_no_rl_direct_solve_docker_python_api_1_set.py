...
from test_rl.test_script.utils import MyException,timeout_handler
import os
...
if __name__ == '__main__':
    info_name = 'info_dict_normal_1109_llm_no_rl_direct_solve_docker_llama3.1:70b_1set_1200s.txt'
